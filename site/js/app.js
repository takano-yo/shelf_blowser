...
const YEAR_OLD = 1792;
const YEAR_STOPS = [
  { y: 2026, h: 190, s: 80, l: 46 }, // 最新: 鮮やかな水色
  { y: 2000, h: 196, s: 78, l: 44 }, // 2000: 水色↔緑の境界（水色側）
  { y: 1950, h: 150, s: 56, l: 38 }, // 1950: 緑↔赤の境界（緑側）
  { y: 1940, h: 16,  s: 52, l: 36 }, // 1950 直下で赤へ切り替え（短い遷移）
  { y: 1900, h: 8,   s: 48, l: 33 }, // 赤
  { y: 1850, h: 5,   s: 42, l: 28 }, // 暗い赤
